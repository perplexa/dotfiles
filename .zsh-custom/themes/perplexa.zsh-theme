...
ZSH_THEME_GIT_PROMPT_ADDED=" %F{green}✚%F{base0}"
ZSH_THEME_GIT_PROMPT_MODIFIED=" %F{blue}✹%F{base0}"
ZSH_THEME_GIT_PROMPT_DELETED=" %F{red}✖%F{base0}"
ZSH_THEME_GIT_PROMPT_UNTRACKED=" %F{yellow}✭%F{base0}"
